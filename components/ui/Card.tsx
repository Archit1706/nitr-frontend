...
import { PropertyType } from "@/types/MainTypes";
...
const Card = ({ properties, fromBid = false }: Props) => {
                            ...
                            <div className="shadow p-4 rounded-lg bg-white">
                                ...
                                <div className="flex gap-3 my-4 flex-wrap">
                                    {property?.amenities.map((amenity, idx) => {
                                        return (
                                            <span
                                                key={idx}
                                                className="px-2.5 py-1 rounded-full bg-gray-300"
                                            >
                                                {amenity}
                                            </span>
                                        );
                                ...
                                <div className="grid grid-cols-2 mt-8">
                                    {property?.typeOfProperty === "bid" ? (
                                        <button
                                            onClick={() => {
                                                router.push("/bid/"+property?._id);
                                            }}
                                            type="button"
                                            className="px-2.5 py-1 bg-orange-400 text-white font-semibold rounded-lg"
                                        >
                                            <ImHammer2 className="inline-block w-4 h-4 mr-3" />
                                            Bid Now!
                                        </button>
                                    ) : (
                                        <button
